...
import com.example.feign.server.FeignSpringServerApplication;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Template")
                .select()
                .apis(RequestHandlerSelectors.basePackage(FeignSpringServerApplication.class.getPackage().getName()))
